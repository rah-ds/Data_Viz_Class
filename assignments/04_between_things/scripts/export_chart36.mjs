/**
 * export_chart36.mjs  –  Export chart 36 (Bar Small Multiples) as PNG
 */
...
const URL = "http://localhost:8765/36_key_bars.html";
const PREFIX = "36_key_bars";
...
async function main() {
  ...
  await page.waitForSelector(".cell svg rect", { timeout: 15_000 });
