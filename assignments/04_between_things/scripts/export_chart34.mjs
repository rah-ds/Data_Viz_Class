/**
 * export_chart34.mjs  –  Export chart 34 (Heatmap) as PNG
 *
 * Prerequisites:
...
const URL = "http://localhost:8765/34_key_heatmap.html";
const PREFIX = "34_key_heatmap";
...
async function main() {
  ...
  await page.waitForSelector(".heatmap-wrap svg rect", { timeout: 15_000 });
