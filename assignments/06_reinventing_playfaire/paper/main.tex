...
\begin{figure}[h]
  \centering
  \href{https://github.com/rah-ds/Data_Viz_Class/tree/main/assignments/06_reinventing_playfaire/viz}{%
    \includegraphics[width=\linewidth]{../static/evidence_trap.pdf}%
  }
  \caption{\small\textcolor{gray}{
    The Evidence Trap (\texttt{evidence\_trap.html}).
    Each row is one arbitration case sliced into 60 equal time windows.
    \textcolor{ev}{Orange} intensity encodes the fraction of edits in that window
    belonging to the evidence phase; all other phases are dark.
    Diagonal hatching marks windows after the last recorded edit.
    Science and Geopolitics (shown expanded) sustain orange well past the midpoint;
    Politics and Policy clear fast and close cleanly.
  }}
